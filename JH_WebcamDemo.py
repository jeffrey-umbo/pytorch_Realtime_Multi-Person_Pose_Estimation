...
class PoseWebCamDemo():
    ...
    def build_model(self):
        ...
        print("==> Build pose estimation model")
    ...
    def handle_one(self, oriImg):
        ...
        # print "* Original image size:", oriImg.shape
...
if __name__ == '__main__':
    ...
    demo = PoseWebCamDemo('./model/pose_model.pth.tar')

    print '==> Test on single image'
    _ = demo.handle_one(np.ones((320,320,3)))
